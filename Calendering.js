...
function addVariable(RollPressure, RollTemperature, CoatingThickness, Adhesion /*  ,**NAME_OF_VARIABLE_NO_SPACE**  */) { 
  ...
  */
  ...
  cell1.innerHTML = RollPressure; 
  cell2.innerHTML = RollTemperature; 
  cell3.innerHTML = CoatingThickness;
  ...
  */
  ...
  document.getElementById('RollPressure').value = null;
  document.getElementById('RollTemperature').value = null;
  document.getElementById('CoatingThickness').value = null;
